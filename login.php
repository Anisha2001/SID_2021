			...
			<div class="row m-0">
				<div class="col-lg-4 offset-lg-2">
					<div class="text-center pb-4">
					    <h1 class="login-title mt-5 text-dark">Log In</h1>
                        <p class="p-1 m-0 font-ubuntu text-black-60">Welcome back to The Spectrum Club</p>
				        <span class="font-ubuntu text-black-60">Not yet a Member? <a href="registration.php">Sign Up</a></span>
					...
					<div class="d-flex justify-content-center">
						<form action="login-process.php" method="post" enctype="multipart/form-data" id="rform">
							...
							<div class="submit-btn text-center my-4">
								<button type="submit" class="btn btn-warning rounded-pill text-dark px-5 ">Log In</button>
							</div>
